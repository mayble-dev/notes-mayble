export default class NotesView {
    ...
    updateNoteList(notes) {
        ...
        const noteOther = document.querySelector('.menu__list')
    ...
    updateActiveNote(note) {
        ...
        this.root.querySelectorAll(".menu__list-item").forEach(noteListItem => {
            noteListItem.classList.remove("menu__list-item-selected");
        });

        this.root.querySelector(`.menu__list-item[data-note-id="${note.id}"]`).classList.add("menu__list-item-selected");
    }

    updateNotePreviewVisibility(visible) {
        this.root.querySelector(".note").style.visibility = visible ? "visible" : "hidden";
    }
}